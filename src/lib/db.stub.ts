...
let store: Record<string, unknown> = {
  ...
  fcCollection: {
    ...
    memberProfiles: {
      "11111009": { clubhouseHatId: "fat-cat-cartel-fedora", bio: "Development fixture: always volunteers to test the snack table." },
      "11111010": { clubhouseHatId: "cartel-flat-cap", bio: "Development fixture: takes the scenic route to every gathering." },
      "11111011": { bio: null },
      "11111012": { clubhouseHatId: "cartel-witch-hat", bio: "Development fixture: brings extra tea for the party." },
      "11111013": { clubhouseHatId: "fat-cat-avatar-ears", bio: "Development fixture: keeps an emergency glamour in every bag." },
      "11111014": { clubhouseHatId: "cartel-tiny-crown", bio: "Development fixture: reports suspiciously good waffle supplies." },
