...
export const COMPLAINT_BATCH_DEBOUNCE_MS = 3_000;
export const MAX_COMPLAINT_BATCH = 1_000;

export const SPUD_JAR_COPY = {
  resetSuccess: "The jar has forgotten everything.",
} as const;
