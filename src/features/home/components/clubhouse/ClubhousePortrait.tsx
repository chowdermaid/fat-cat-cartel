...
import { ClubhouseHat } from "@/features/member-profile/components/profile/ClubhouseHat";
import { getClubhouseHat } from "../../utils/clubhouseHats";
import { CLUBHOUSE } from "../../constants";
import type { ClubhouseProps, ClubhouseProtection } from "../../types";
import { getClubhouseFootprint } from "../../utils/clubhouse";
...
export const ClubhousePortrait = memo(function ClubhousePortrait({ id, member, bio, hatId, size, register, protect }: Props) {
  ...
  const footprint = getClubhouseFootprint(size, CLUBHOUSE, getClubhouseHat(hatId));
          ...
          <Tooltip open={tooltipOpen} onOpenChange={updateTooltip}>
            <TooltipTrigger asChild>
              <Link
                ...
                className="relative isolate block rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e2b365] focus-visible:ring-offset-4 focus-visible:ring-offset-[#211b17]"
              ...
              >
                ...
                <ClubhouseHat hatId={hatId} size={size} />
                <span
                  aria-hidden="true"
