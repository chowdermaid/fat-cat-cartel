...
## Summary
- 2128 nodes · 4328 edges · 137 communities (117 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `caf3e838`
...
2. `ContentType` - 25 edges
3. `MemberData` - 25 edges
4. `compilerOptions` - 22 edges
5. `calculateMeowketProfitForAdmin()` - 21 edges
6. `formatQuantity()` - 20 edges
7. `registerDefaultHandlers()` - 19 edges
8. `ZoneEncounter` - 18 edges
9. `compilerOptions` - 18 edges
10. `callAdminFunction()` - 17 edges
...
Cohesion: 0.03
Nodes (63): acceptCraftingRequest, adminAppOrigin, adminAuthConfig(), adminAuthConfigWithHousecat(), adminAuthConfigWithSingleMemberRole(), adminAuthConfigWithSingleMemberRoleAndHousecat(), approveCalendarEventRequest, calculateMeowketProfit (+55 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (59): assertAuthenticated(), assertCapability(), assertDevLayer(), CalendarRequest, CalendarRequestCreator, CalendarStore, callDevAdminFunction(), cleanText() (+51 more)
...
Cohesion: 0.13
Nodes (17): CalendarSyncStatus(), ParticipantCardProps, MemberDeleteDialog(), MemberDeleteDialogProps, parseStatus(), useCalendarSyncStatus(), AdminAuthState, AdminPageShellProps (+9 more)
...
Cohesion: 0.09
Nodes (21): adminRoute, calendarRoute, craftingBoardRoute, dmuProgRoute, easter2026Route, fcCollectionRoute, fcLeaderboardRoute, fcTypeRoute (+13 more)
...
Cohesion: 0.13
Nodes (20): MemberRosterTable(), MemberRosterTableProps, StatusCell(), MemberSyncToolbar(), MemberSyncToolbarProps, FRESHNESS_MS, SOURCE_LABEL, MemberSyncStatus (+12 more)
...
Cohesion: 0.12
Nodes (15): dependencies, firebase-admin, firebase-functions, devDependencies, @types/node, typescript, engines, node (+7 more)
...
Cohesion: 0.27
Nodes (6): AdminPage(), AdminHeader(), AdminHeaderProps, EasterEventCard(), EasterEventCardProps, SelectedAdminView

### Community 74 - "Community 74"
Cohesion: 0.29
Nodes (6): deleteEasterParticipantAdmin(), upsertEasterParticipantAdmin(), ParticipantCard(), ParticipantManager(), ParticipantManagerProps, useEasterParticipants()
